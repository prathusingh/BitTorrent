...
public class FileSplitter
	...
	public static void join(String baseFilename) throws IOException
		{
		String directory = "C:\\Apache\\htdocs\\bittorrent\\files\\"+stripExtension(baseFilename);
		...
		BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream("C:\\BitTorrent\\Downloads\\"+baseFilename));
